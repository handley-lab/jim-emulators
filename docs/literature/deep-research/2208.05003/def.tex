\newcommand{\x} {{\bf x}}
\def\wG{\bar{\rmG}}
\newcommand\florentin[1]{{\color{blue} Florentin: #1}}
\newcommand \ox {{\bar x}}
\newcommand \om {{\omega}}
\newcommand \bs {{s}}  %{{\boldsymbol s}}
\newcommand \twx {\bar{x}}
\newcommand \tox {{\bar x}} %{\tilde{\bar{x}}}
\newcommand\lb{{\langle}}
\newcommand\rb{{\rangle}}
\newcommand \oG {{\bar \rmG}}
\newcommand\Ld{{\bf L^2}}
\newcommand\error{{E}}  % {{\rmE}}
\newcommand\txwav{x}
\def\rM{\mathrm{M}}
...
\newcommand{\barfx}{\overline{\mathbf{x}}}
\newcommand{\barfX}{{\mathbf{\bar{X}}}}
\newcommand{\barfY}{{\mathbf{\bar{Y}}}}
...
\newcommand{\expeLignesqrt}[1]{\PE^{1/2} [ #1 ]}
\newcommand{\expeLignesqrtt}[1]{\PE^{1/4} [ #1 ]}
...
\newcommand{\jeremy}[1]{\todo[color=blue!20]{{\bf JH:} #1}}
...
\newcommand{\simon}[1]{\todo[color=green!20]{{\bf Simon:} #1}}
...
\def\VEa{V}
\def\KUa{K}
\newcommandx{\KL}[2]{\operatorname{KL}\left( #1 \middle\Vert #2 \right)}
\newcommandx{\KLsqrt}[2]{\operatorname{KL}^{1/2}\left( #1 \middle\Vert #2 \right)}
\newcommandx{\KLLignesqrt}[2]{\operatorname{KL}( #1 \Vert #2 )^{1/2}}
\newcommandx{\Jef}[2]{\operatorname{J}\left( #1 , #2 \right)}
\newcommandx{\JefLigne}[2]{\operatorname{J}( #1 , #2 )}
\newcommandx{\KLLigne}[2]{\operatorname{KL}( #1 \Vert #2 )}
