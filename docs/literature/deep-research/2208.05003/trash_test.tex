...
%     \centering
%     \begin{tabular}{cc}
%     \includegraphics[height=0.17\textheight]{img/spec_pow_vs_L_2.png}&\includegraphics[height=0.17\textheight]{img/N_versus_L_2.png}
%     \end{tabular}
...
%     \includegraphics[height=0.14\textheight]{img/perf_vs_steps_phi4_langevin0.png} \hfill \includegraphics[height=0.14\textheight]{img/examples_syntheses_true.png} \hfill \includegraphics[height=0.14\textheight]{img/psd_of_phi4.png}
...
% \begin{figure}
%   \begin{center}
%     \includegraphics[width=0.2\textwidth]{img/phi4.png}    \includegraphics[width=0.2\textwidth]{img/phi4_wavelets.png}
%   \end{center}
